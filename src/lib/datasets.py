...
class NSDTSEADataset():
    ...
    def __init__(self, cfg):
        ...
        self.target_field_length = cfg['target_field_length']
        self.receptive_field_length = util.compute_receptive_field_length(cfg['dilations'], cfg['filter_length'], 1) 
        self.input_length = (self.receptive_field_length -1) + self.target_field_length
        ...
        self.noise_only_percent = cfg['noise_only_percent']
        self.regain = cfg['regain']
        self.extract_voice = cfg['extract_voice']
        self.in_memory_percentage = cfg['in_memory_percentage']
        self.num_sequences_in_memory = 0
        self.condition_encode_function = util.get_condition_input_encode_func(cfg['condition_encoding'])
